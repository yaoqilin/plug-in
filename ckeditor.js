    ...
    */
    ...
    (function() {
        ...
        function W(a) {
            if (a.draggable) {
                ...
                c ? d = c.findOne("img") : (c = new CKEDITOR.dom.element("span", b.document), c.setAttributes({
                    ...
                    style: "background:rgba(220,220,220,0.5);background-image:url(" + b.plugins.widget.path +
                        "images/handle.png)"
                ...
                if (!a.inline && (d.on("mousedown", X, a), CKEDITOR.env.ie && 9 > CKEDITOR.env.version)) d.on("dragstart", function(a) {
        ...
        function X(a) {
            function b() {
                var c;
                for (q.reset(); c = g.pop();) c.removeListener();
                var b = k;
                c = a.sender;
                ...
                CKEDITOR.tools.isEmpty(e.visible) || (b = d.getRange(b[0]), this.focus(), f.fire("drop", {
                    dropRange: b,
                    target: b.startContainer
                }));
            ...
            g.push(f.document.once("mouseup",
                b, this));
        ...
        function aa(a) {
            if (a.parts) {
                var b = {},
                    c, d;
                for (d in a.parts) c =
                    a.wrapper.findOne(a.parts[d]), b[d] = c;
                a.parts = b
            }
        }
        ...
        function N(a, b) {
            ...
            W(a);
            V(a);
            if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version) a.wrapper.on("dragstart", function(c) {
                var b = c.data.getTarget();
                g.getNestedEditable(a, b) || a.inline && g.isDomDragHandler(b) || c.data.preventDefault()
            });
            ...
            a.on("key", function(b) {
                ...
                if (13 == b) a.edit();
                    ...
                    if (b in
                        ca || CKEDITOR.CTRL & b || CKEDITOR.ALT & b) return
                }
                return !1
            }, null, null, 999);
        ...
        function p(a) {
            ...
            a.widgets.add("codeSnippet", {
                ...
                data: function() {
                    ...
                    b && a.lang != b.lang && this.parts.code.removeClass("language-" +
                        b.lang);
                ...
                upcast: function(d, c) {
                    if ("pre" == d.name) {
                        for (var g = [], e = d.children, k, l = e.length - 1; 0 <= l; l--) k = e[l], k.type == CKEDITOR.NODE_TEXT && k.value.match(q) || g.push(k);
                        var f;
            ...
            afterInit: function(a) {
                ...
                if (!a._.codesnippet.highlighter) {
                    var e = new CKEDITOR.plugins.codesnippet.highlighter({
                        ...
                        init: function(h) {
                            var e = this;
                            n && CKEDITOR.scriptLoader.load(b + "lib/highlight/highlight.pack.js", function() {
                                e.hljs = window.hljs;
                                h()
                            });
                            a.addContentsCss && a.addContentsCss(b + "lib/highlight/styles/" + a.config.codeSnippet_theme +
                                ".css")
                        },
    ...
    CKEDITOR.config.plugins = 'dialogui,dialog,basicstyles,clipboard,button,toolbar,enterkey,entities,floatingspace,wysiwygarea,indent,indentlist,fakeobjects,list,undo,lineutils,widget,codesnippet,autolink,wecenterlink,wecenterattach,justify,removeformat';
